...
if __name__ == "__main__":
    ...
    with open('/data/ephraim/datasets/known_noise/undiff/exp_ar_h_white/scaling_snrs.pickle', 'rb') as handle:
        snr_df = pickle.load(handle)
    root = "/data/ephraim/datasets/known_noise/undiff/exp_ar_h_white/"
    snr_df
    ...
    for i in tqdm(range(len(snr_df["snr"]))):
        ...
        pickle_path = cur_dir/("snr"+str(int(cur_snr))+"_0_1models.pickle")
