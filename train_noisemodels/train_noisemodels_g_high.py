...
if __name__ == "__main__":
    ...
    with open('/data/ephraim/datasets/known_noise/undiff/exp_ar_g_high/5f_snrs.pickle', 'rb') as handle:
        snr_df = pickle.load(handle)
    root = "/data/ephraim/datasets/known_noise/undiff/exp_ar_g_high/"
    snr_df
    ...
    command = "python run_exp_ar_g_high.py"
    os.system(command)