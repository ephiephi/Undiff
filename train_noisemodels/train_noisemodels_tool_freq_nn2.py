        ...
        for epoch in range(epochs):
            ...
            if epoch%10==0:
                with torch.no_grad():
                    ...
                    magnitude_test =  (torch.abs(stft_test))
...
if __name__ == "__main__":
    print("starting ----")
    root = "/data/ephraim/datasets/known_noise/undiff/exp_ar_j_real_freq_nn2/"
    print(root)
    ...
    for i in tqdm(snr_df2.index):
        ...
        # raise Exception
            ...
            nets,loss_array,loss_test_array = train_nets(train_dataset, test_dataset,trial,epochs=6000,num_nets=200)
