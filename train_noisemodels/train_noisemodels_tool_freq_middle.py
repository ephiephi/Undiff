...
def create_dataset_real(noise_whole, sr):
    ...
    print("len(noise_sample2): ",len(noise_sample2))
...
if __name__ == "__main__":
    ...
    # root = "/data/ephraim/datasets/known_noise/undiff/exp_ar_i_real_freq_middle/"
    root = "/data/ephraim/datasets/known_noise/undiff/exp_ar_j_real_freq/"
