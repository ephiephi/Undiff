...
noisy_dir = "/data/ephraim/datasets/known_noise/sgmse/exp_l/noisy_wav"
clean_dir = "/data/ephraim/datasets/known_noise/sgmse/exp_l/clean_wav"
root = Path("/data/ephraim/datasets/known_noise/sgmse/exp_l/enhanced/")
