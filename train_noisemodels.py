...
if __name__ == "__main__":
    ...
    with open('/data/ephraim/datasets/known_noise/undiff/exp_ar_h_0.99/scaling_snrs.pickle', 'rb') as handle:
        snr_df = pickle.load(handle)
    root = "/data/ephraim/datasets/known_noise/undiff/exp_ar_h_0.99/"
    snr_df
