...
mainroot = Path("/data/ephraim/datasets/known_noise/undiff_exps/exp_k/")
roots = [ mainroot/"a",mainroot/"b",mainroot/"c"] #,h,ij
for root in roots:
    print("root: ", root)
    ...
    for wav in tqdm(noiswavs):
        ...
        for j in [0]:
            ...
            s_array1 =[0.08,0.09,0.1,0.11, 0.12,0.15,0.001,0.01,0.05,]
            s_array2=[0.2,0.3,0.5,0.7,0.8,0.07,0.005]
