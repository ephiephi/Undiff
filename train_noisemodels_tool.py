...
def train_nets_process(train_dataset, test_dataset, device, idxes,trial, epochs=6000):
    ...
    for i in idxes:
        ...
        if i<20 and epochs>2000:
            cur_epochs = epochs + 1000
...
if __name__ == "__main__":
    ...
    for i in snr_df.index:
        ...
        # raise Exception
            ...
            nets,loss_array,loss_test_array = train_nets_parralel(train_dataset, test_dataset,trial,epochs=6000,num_nets=200)
