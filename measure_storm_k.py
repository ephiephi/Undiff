...
noisy_dir = "/data/ephraim/datasets/known_noise/sgmse/exp_k/noisy_wav"
clean_dir = "/data/ephraim/datasets/known_noise/sgmse/exp_k/clean_wav"
root = Path("/data/ephraim/datasets/known_noise/sgmse/exp_k/enhanced/")
