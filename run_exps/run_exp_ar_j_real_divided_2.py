...
for root in roots:
    ...
    for wav in tqdm(noiswavs):
        ...
        for l_low in [1.0,0.9,0.8,0.5]:
            ...
            # s_array1 =[0.0001,0.001,0.005,0.05,0.01]#,
            s_array1 = []
            # s_array2=[0.0005,0.00001,0.08,0.1,0.2,0.003,0.0003]
