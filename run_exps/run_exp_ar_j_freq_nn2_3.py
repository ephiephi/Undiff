...
for root in roots:
    ...
    for wav in tqdm(noiswavs):
        ...
        for j in [0]:
            ...
            s_array2=[0.09, 0.1,0.12,0.15,0.2,0.3,0.5,0.8,1.0, 1.2]
            s_array1 = []
            ...
            for s in s_array: 
                ...
                if not os.path.exists(newOUTPATH):
                    os.mkdir(newOUTPATH)
                command = "HYDRA_FULL_ERROR=3 CUDA_VISIBLE_DEVICES=2 python main.py model=diffwave task=unconditional output_dir=results/guided audio_dir=1 guid_s={} y_noisy={} outpath={} s_schedule={} noise_type={} noise_model_path={}".format(s,wav, newOUTPATH, s_schedule, "freq_nn",noise_model_path) 
