...
roots = ["/data/ephraim/datasets/known_noise/undiff/exp_ar_h_white/a","/data/ephraim/datasets/known_noise/undiff/exp_ar_h_white/b","/data/ephraim/datasets/known_noise/undiff/exp_ar_h_white/c"]
for root in roots:
    ...
    for wav in tqdm(noiswavs):
        ...
        noise_model_path = root+f"/snr{snr}_0_1models.pickle"
