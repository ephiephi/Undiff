...
mainroot = Path("/data/ephraim/datasets/known_noise/undiff/exp_ar_j_real_freq_nolog/")
...
for root in roots:
    ...
    for wav in tqdm(noiswavs):
        ...
        for j in [0]:
            ...
            # s_array1 =[0.00001,0.00005,0.0005,0.0001,0.001,0.01,0.02,0.03,0.06,0.07]
            ...
            for s in s_array: 
                ...
                if not os.path.exists(newOUTPATH):
                    os.mkdir(newOUTPATH)
                command = "HYDRA_FULL_ERROR=2 CUDA_VISIBLE_DEVICES=1 python main.py model=diffwave task=unconditional output_dir=results/guided audio_dir=1 guid_s={} y_noisy={} outpath={} s_schedule={} noise_type={} noise_model_path={}".format(s,wav, newOUTPATH, s_schedule, "freq_gaussian_nolog",noise_model_path) 
