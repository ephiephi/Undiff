...
def main():
    ...
    parser.add_argument('--save_model_path', type=str, default="/data/ephraim/datasets/known_noise/undiff_exps/training_all/all_noises_net8b/model.pth",
                        help="Path to save model state dict (e.g. 'model.pth').")
    parser.add_argument('--save_test_list', type=str, default="/data/ephraim/datasets/known_noise/undiff_exps/training_all/all_noises_net8b/testset.txt",
    ...
    model = NetworkNoise8(kernel_size=9)
